...
export default function PythonPage() {
  return (
    <main className={`min-h-screen px-6 py-10 ${bodyFont.className} bg-[#f9fafb] text-gray-900`}>
      <h1 className={`text-4xl font-bold mb-6 ${headingFont.className}`}>Python</h1>
      <p className="text-gray-600 mb-6">Start your programming journey with Python fundamentals.</p>
